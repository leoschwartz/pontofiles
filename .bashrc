...
function build() {
	# Paths do camaro e linux.mak
	bld_camaro="/home/leo/Sandbox/zoe-games-src/programs/camaro/im/camaro.cc"
	...
	# Separa o nome do jogo e a resolução
	jogo="${input%_*}"
	res="${input##*_}"
	
	# Paths para as pastas dos jogos
	declare -A jogos
	jogos["CoinFestival_5"]="/home/leo/Sandbox/zoe-games-src/firepot-bld/cfestpanda-vertical-1080-hli"

	path=""

	# Pega o path do jogo
	if [[ -n "${jogos[$input]}" ]]; then
		path="${jogos[$input]}"
	else
		echo "Jogo invalido"
		return 1
